...
All adapters live in `provider/`. Provider-specific wire formats stay inside adapters; the agent, session store, server, and web UI only see canonical messages.
